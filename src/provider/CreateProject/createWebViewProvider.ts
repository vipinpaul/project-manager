...
export class CreateWebViewProvider implements vscode.WebviewViewProvider {
	/**
	...
	public static register(
		...
		return vscode.window.registerWebviewViewProvider(
			CreateWebViewProvider.viewType,
			new CreateWebViewProvider(context),
		);
	}

	private static readonly viewType = 'project-manager-sidebar';
	...
	public async resolveWebviewView(
		...
		// 				const versification =
		// 					this._metadata &&
		// 					(await getVersification(this._metadata));
		// 				if (versification) {
