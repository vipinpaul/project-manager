...
import { CreateWebViewProvider } from './provider/CreateProject/createWebViewProvider';
...
export function activate(context: vscode.ExtensionContext) {
 ...
 /**
   * Register Craete Project provider
   */
  context.subscriptions.push(CreateWebViewProvider.register(context));
